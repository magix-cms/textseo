...
<div class="row">
    <form id="edit_textseo" action="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&amp;action=edit&edit={$page.id_to}" method="post" class="validate_form edit_form col-ph-12 col-lg-12">
        <div class="row">
