...
<div class="row">
    <form id="add_textseo" action="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&amp;action=add" method="post" class="validate_form add_form col-ph-12 col-lg-12 collapse in">
        <div class="row">
